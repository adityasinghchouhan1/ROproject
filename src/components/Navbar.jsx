    ...
    <div>
      ...
      >
        <div className="container mx-auto flex items-center justify-between px-6 py-4 relative">
          {/* Logo */}
          <div className="sm:text-4xl text-lg  font-bold tracking-wider transition-all duration-300">
            <Link
              to="/"
              className={`${
          ...
          {/* Desktop Navigation */}
          <nav className="flex-grow flex justify-center sm:space-x-8 space-x-3 ">
            <Link
              to="/"
          ...
          >
            ...
            <a
              href="tel:+9926980487"
              className={`sm:text-lg text-sm font-medium hover:text-blue-700 flex items-center space-x-2 ml-4 ${
                isScrolled ? 'text-gray-700' : 'text-white'
              }`}
            >
              +91 - 9926980487
